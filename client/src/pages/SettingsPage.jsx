...
const PREVIEW_MESSAGES = [
    {id:1, content: "Salut! Comment vas-tu ?", isSent: false},
    {id:2, content: "Je vais bien et toi ? Quoi de neuf ?", isSent: true}
]
    ...
    return (
        ...
        <div className="space-y-6">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-base-content/70">Choisissez un thème pour vos discussions</p>
          </div>
